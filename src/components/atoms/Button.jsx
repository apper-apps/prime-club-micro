...
const variants = {
    primary: "bg-gradient-to-r from-primary-500 to-coral-600 hover:from-primary-600 hover:to-coral-700 text-white shadow-soft hover:shadow-glow focus:ring-primary-500 font-semibold",
